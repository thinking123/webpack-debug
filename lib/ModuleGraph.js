...
class ModuleGraph {
	...
	setResolvedModule(originModule, dependency, module) {
		...
		const mgd = this._getModuleGraphDependency(dependency);//return ModuleGraphDependency
		mgd.connection = connection;
		const connections = this._getModuleGraphModule(module).incomingConnections;//return ModuleGraphModule
