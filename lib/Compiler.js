...
class Compiler {
	...
	run(callback) {
		...
		const onCompiled = (err, compilation) => {
			...
			process.nextTick(() => {
				...
				this.emitAssets(compilation, err => {//输出文件
	...
	newCompilation(params) {
		...
		this.hooks.thisCompilation.call(compilation, params); //挂载hooks
		this.hooks.compilation.call(compilation, params); //挂载hooks
		return compilation;
	}
