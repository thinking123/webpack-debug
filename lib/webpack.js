...
const createCompiler = rawOptions => {
	const options = getNormalizedWebpackOptions(rawOptions); //标准 webpack option
	applyWebpackOptionsBaseDefaults(options);
	const compiler = new Compiler(options.context); //编译器
	...
	applyWebpackOptionsDefaults(options); // 设置 webpack options default
	compiler.hooks.environment.call();
	compiler.hooks.afterEnvironment.call();
	new WebpackOptionsApply().process(options, compiler); //根据webpack options 配置 Compiler hooks
